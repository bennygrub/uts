...
class BookAuthorsControllerTest < ActionController::TestCase
  ...
  test "should create book_author" do
    assert_difference('BookAuthor.count') do
      post :create, book_author: { book_id: @book_author.book_id, first_name: @book_author.first_name, last_name: @book_author.last_name }
    end
  ...
  test "should update book_author" do
    patch :update, id: @book_author, book_author: { book_id: @book_author.book_id, first_name: @book_author.first_name, last_name: @book_author.last_name }
    assert_redirected_to book_author_path(assigns(:book_author))
  end
